!> @file
!> This file contains the subroutines that  write and read binary file for restarting the computation
!////////////////////////////////////////////////////////////////////////////////////////////////
!////////										////////
!////////	restart.f90								////////
!////////										////////
...
!///////////////////////////////////////////////////////////////////////////////////////////////
!> @brief
!> This subroutine writes out binary file for restarting the computation.
!!
!
...
write(*,*) 'write stats'
       ...
       ELSEIF (rms .and. (.not. rmscont)) THEN
...
!///////////////////////////////////////////////////////////////////////
!> @brief
!> This subroutine reads infomation from binary file for restarting the computation
!!
!
...
!
      ...
      CALL MPI_BCAST(nmortmpi,nmp*numprocs*3,MPI_INTEGER,0,comm1d,ierr)
      CALL MPI_BCAST(nslavempi,nmp*numprocs*3,MPI_INTEGER,0,comm1d,ierr)
!
      IF (myid ==0) THEN
...
!///////////////////////////////////////////////////////////////////////////////////////////////
!> @brief
!> This subroutine writes out matrices for restarting the computation
!!
!
...
!///////////////////////////////////////////////////////////////////////////////////////////////
!> @brief
!> This subroutine writes out all the domain data needed for restarting the computation
!!
!
...
!///////////////////////////////////////////////////////////////////////////////////////////////
!> @brief
!> This subroutine writes out the data in the mortart
!!
!
