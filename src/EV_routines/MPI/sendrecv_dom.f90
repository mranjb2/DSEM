...
!
      ...
      IF (nsend==1) THEN
        ...
        CALL MPI_SEND (             		     	            &
             ...
             comm1d,ierr)
        CALL MPI_SEND (             		     	            &
             d%c_beta,nx*ny*nz, MPI_DOUBLE_PRECISION,inode,itag,     &
             comm1d,ierr)
        CALL MPI_SEND (             		     	            &
             d%RHS_ent,nx*ny*nz, MPI_DOUBLE_PRECISION,inode,itag,     &
             comm1d,ierr)
        CALL MPI_SEND (             		     	            &
             d%muhg,nx*ny*nz, MPI_DOUBLE_PRECISION,inode,itag,     &
             comm1d,ierr)
        CALL MPI_SEND (             		     	            &
             d%nu_t,nx*ny*nz, MPI_DOUBLE_PRECISION,inode,itag,     &
             comm1d,ierr)
        IF (statis) THEN
          itag = itag+1
           CALL MPI_SEND (             		     	            &
             stats%Q_av,ny*nz*(neq+nav), MPI_DOUBLE_PRECISION,inode,itag,          &
             comm1d,ierr)
        ENDIF
      ENDIF
...
!
      ...
      IF (nsend==2) THEN
        itag = itag+1
        CALL MPI_SEND (             		     	            &
             statsfluct%Q_fluct,ny*nz*nfluct, MPI_DOUBLE_PRECISION,inode,itag,          &
             comm1d,ierr)
      ENDIF
...
!//////////////////////////////////////////////////////////////
!
      SUBROUTINE send_domain_da(d,nsend,inode,itag)
...
!
      ...
      RETURN 
      END SUBROUTINE send_domain_da
!
!//////////////////////////////////////////////////////////////
!
      SUBROUTINE recv_domain_da(d,nsend,inode,itag)
