!>\file WrtPlotFiles_turb.f90
!! Tecplot / VisIt plotting routines which include the plotting of turbulent viscosity,
!! \f$ nu_t \f$, in addition to solution variables
!!

!> @brief Writes out data (in serial or parallel) in a *.TEC tecplot format.
!! May be read by TecPlot, VisIt, or ParaView.
...
!
      ...
      ELSE
       ...
       WRITE(plt_unit,*) ' VARIABLES = "x","y","z","p","u","v","w","rho","T","nu_t"'
      END IF
...
!
         ...
         ELSE 
          CALL fill_plot_arrays(da,Q,nu_t(id,:,:,:),nu,x,y,z,scale)
         ENDIF
!
...
!///////////////////////////////////////////////////////////////////////
!
   SUBROUTINE fill_plot_arrays(d,Q,nut,nu,x,y,z,scale) 
!
!......................................................................
!     date: 11/13/98                                                      
!
...
!
    ...
    double precision, dimension(nx+1,ny+2,nz+2)             :: nu
